...
class SimpleHTMLDomApi
{
    ...
    public static function stringGetHTML($str, $lowercase = true, $forceTagsClosed = true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN = false, $defaultBRText = DEFAULT_BR_TEXT, $defaultSpanText = DEFAULT_SPAN_TEXT)
    {
        $dom = new simple_html_dom(null, $lowercase, $forceTagsClosed, $target_charset, $stripRN, $defaultBRText, $defaultSpanText);
...
class simple_html_dom
{
    ...
    protected function prepare($str, $lowercase = true, $stripRN = true, $defaultBRText = DEFAULT_BR_TEXT, $defaultSpanText = DEFAULT_SPAN_TEXT)
    {
        ...
        $this->root                     = new SimpleHTMLDomApi($this);
        $this->root->tag                = 'root';
    ...
    protected function parse()
    {
        ...
        $node = new SimpleHTMLDomApi($this);
        ++$this->cursor;
    ...
    {
        return @stringGetHTML("<$name>$value</$name>")->first_child();
    }
    function createTextNode($value)
    {
        return @end(stringGetHTML($value)->nodes);
    }
    function getElementById($id)
    {
        return $this->find("#$id", 0);
